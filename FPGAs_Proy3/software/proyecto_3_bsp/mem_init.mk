...
# Memory: on_chip_memory
MEM_0 := proyecto3_system_on_chip_memory
$(MEM_0)_NAME := on_chip_memory
...
$(MEM_0)_HIERARCHICAL_PATH := on_chip_memory
$(MEM_0)_WIDTH := 32
$(MEM_0)_HEX_DATA_WIDTH := 32
$(MEM_0)_ENDIANNESS := --little-endian-mem
$(MEM_0)_CREATE_LANES := 0

.PHONY: on_chip_memory
on_chip_memory: check_elf_exists $(MEM_INIT_DIR)/$(MEM_0).hex $(HDL_SIM_DIR)/$(MEM_0).dat $(HDL_SIM_DIR)/$(MEM_0).sym
